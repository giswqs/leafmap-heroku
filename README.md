...
Python scripts for deploying Earth Engine Apps to heroku, try it out: <https://leafmap-demo.herokuapp.com/>
...
- Clone this repository: <https://github.com/giswqs/leafmap-heroku>
...
- Edit the `Procfile` file by replacing `notebooks/leafmap.ipynb` with the path to your own notebook.
